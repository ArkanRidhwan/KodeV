...
class TambahSiswaFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.ivFotoTambahSiswa.setOnClickListener {
        ...
        binding.btnSubmitTambahSiswa.setOnClickListener {
            binding.apply {
                progressCircular.visible()
                btnSubmitTambahSiswa.gone()
                val name = etNamaTambahSiswa.text.toString()
                val job = etPekerjaanTambahSiswa.text.toString()
                val age = etUmurTambahSiswa.text.toString()
                val student = Student(
                    name = name,
                    job = job,
                    age = age,
