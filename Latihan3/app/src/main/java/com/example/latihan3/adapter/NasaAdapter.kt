...
import com.example.latihan3.databinding.BahanrvNasaAstronomyBinding
...
class NasaAdapter : RecyclerView.Adapter<NasaAdapter.ListViewHolder>() {
    ...
    inner class ListViewHolder(private val binding: BahanrvNasaAstronomyBinding) :
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListViewHolder {
        val binding =
            BahanrvNasaAstronomyBinding.inflate(LayoutInflater.from(parent.context), parent, false)
